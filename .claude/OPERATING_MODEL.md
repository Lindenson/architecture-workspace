...
> **Scope: LOOP A.** Все режимы ниже — режимы сопровождения архитектуры:
> наблюдать, сверять, докладывать; продуктовый код только на чтение. Изменение
> системы — это **Loop B**, отдельный цикл со своими фазами, воротами и правами
> записи. Daily/Weekly/Monthly процедуры ниже тоже относятся только к Loop A и
> не описывают жизненный цикл фичи.
> Контракт: [`OPERATING_LOOPS.md`](OPERATING_LOOPS.md).
